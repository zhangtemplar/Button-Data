...
class PedailyInvestSpider(ButtonSpider):
    name = 'pedaliy_invest'
    ...
    def parse(self, response):
        ...
        for row in response.xpath("//ul[@id='inv-list']/li"):
            ...
            round = row.xpath("dl/dt[@class='money']/span[@class='r']/text()").extract_first()
            ...
            investor_name = row.xpath("dl/dt[@class='group']/a/text()").extract_first()
            investor_url = row.xpath("dl/dt[@class='group']/a/@href").extract_first()
            if investor_name is None:
                investor_name = row.xpath("dl/dt[@class='group']/text()").extract_first()
